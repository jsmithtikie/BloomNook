 ...
 * This file demonstrates how to integrate Bloomnook with a web frontend
 */

// For React/Vue/Angular applications
export class BloomnookClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new BloomnookClient(provider, contractAddress);
